...
import fr.esiag.isies.pds.model.bi.finance.staging.StagingOrgaType;
 ...
 *
 */
public class StagingOrganization extends AbstractEntity {
	 ...
	 * Type of orga.
	 */
	private StagingOrgaType orgaType;

	/**
	 * List of services in the hospital
	 */
	
	private Set<StagingServiceType> servicesSet = new HashSet<StagingServiceType>(0);

	public Set<StagingServiceType> getServicesSet() {
		return servicesSet;
	}

	public void setServicesSet(Set<StagingServiceType> servicesSet) {
	...
	public StagingOrgaType getOrgaType() {
		return orgaType;
	}

	public void setOrgaType(StagingOrgaType orgaType) {
